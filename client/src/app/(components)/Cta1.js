...
const Cta1 = () => {
  return (
    <div className="relative h-screen lg:h-[85vh]  flex flex-col lg:flex-row w-full px-6 gap-2 mt-10 lg:mt-10">
      {/* Left */}
      <div className="relative flex flex-col gap-12 justify-center items-center w-full lg:w-3/5 bg-white px-2 ">
        {/* <img
        ...
        <div className="flex flex-col justify-center items-center gap-8 z-10 ">
          <span className="text-4xl lg:text-6xl font-bold text-red-700 text-center leading-[3rem]">
        ...
        <div className="flex flex-row items-center gap-4 z-10">
          <Link
            href={"/contact"}
            className="border-2 bg-red-600 px-3 py-3 cursor-pointer text-white hover:bg-black  transition-all ease-in duration-300 rounded-md"
          >
            Contact Us
          </Link>
        </div>
